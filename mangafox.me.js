...
css = "#header{background:#3a3a3a none!important;position:relative!important;top:-75px!important;z-index:10!important;padding-bottom:15px!important}#header:hover{background:#5a5a5a none!important;position:relative!important;top:0!important}body{background-image:url(user-upload)!important}.page #bottom_center_bar{width:600px!important}.ad,#tip,#chnav,#pgnav,#related,#tags,#footer,#shares,#tool,.page #top_right_bar,.page #top_center_bar,.page #top_left_bar,.page a.prev_page,.page a.next_page,#bookmark,#comments,.news-block-magick{display:none!important}.page #top_right_bar,.page #bottom_right_bar,.page #top_center_bar,.page #bottom_center_bar,.page #top_left_bar,.page #bottom_left_bar{background:none!important}.widepage.page{width:600px;top:-60px!important;position:relative!important}.l{color:#fff!important}#viewer{position:relative!important;top:-85px!important;border:0 solid rgba(0,0,0,.3)!important;padding:0!important;background:transparent!important}#menu li{border-radius:.3em!important;margin-right:5px!important}#menu li a:hover{border-radius:.3em!important}#menu li{background:#fff!important}#menu li a{padding-top:8px!important;height:26px!important}#bottom_chapter_list,select.m{background:#1a1a1a!important;border-width:0!important;box-shadow:rgba(0,0,0,.6) 0 1px 3px 0 inset,rgba(255,255,255,.05) 0 0 0 1px,rgba(255,255,255,.1) 0 1px 0 0!important}";
GM_addStyle(css);